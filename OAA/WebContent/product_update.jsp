...
<%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%><div id="all">
     ...
     <div class="table-responsive">
      <table class="table">
       <div id="hot">
        ...
        <form:form action="productupdate.do"
         ...
         <div class="row">
          <div class="col-sm-6">
           <div class="form-group">
            ...
            <form:select styleClass="form-control" styleId="productName"
             path="productName">
          ...
          <div class="col-sm-6">
           <div class="form-group">
            ...
            <form:select styleClass="form-control" styleId="category"
             path ="category">
         ...
         <div class="row">
          <div class="col-sm-6">
           <div class="form-group">
            ...
            <form:text styleClass="form-control" styleId="description"
             path="description" />
           </div>
          </div>
          <div class="col-sm-6 ">
           <div class="form-group">
            ...
            <form:file styleClass="form-control" styleId="photo"
             path="image" style="border: none" />
           </div>
          </div>
         </div>
         <div class="row">
          <div class="col-sm-6">
           <div class="form-group">
            ...
            <form:text styleClass="form-control" styleId="minBidPrice"
             path="minBidPrice" />
           </div>
          </div>
         </div>
